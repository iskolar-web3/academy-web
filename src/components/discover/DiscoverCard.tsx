 ...
 * (+N more), overlapping member avatars, and an upvote button. Real search/filter/upvote
 * wiring lands in P3; this renders the mock showcase data.
 */
...
export function DiscoverCard({ project }: { project: MockProject }) {
	...
	return (
		<div className="card-surface flex h-[412px] flex-col overflow-hidden rounded-[15px] transition-transform hover:-translate-y-1">
			<div
			...
			<div className="flex min-h-0 flex-1 flex-col px-[17px] pt-4 pb-[17px]">
				<span className="mb-2 truncate text-[18.5px] leading-tight text-content-heading">
					{project.title}
				</span>
